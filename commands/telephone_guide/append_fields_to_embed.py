"""
//  /handlers/telephone_guide/append_fields_to_embed.py
//  py-bot-uprm
//
...
def append_fields_to_embed(contact: Contact, embed: Embed):
    embed.add_field(name="Nombre del Dept.", value=contact.contact_name)
    embed.add_field(name="Descripción", value=contact.contact_description)
    embed.add_field(name="Servicios Provistos", value=contact.services_provided)
    ...
    embed.add_field(name="Localización en Google Maps", value=contact.gmaps_location)
