...
class DecanatoEstudiantes(Contact):
    def __init__(self):
        ...
        contact_description = "Proveer al estudiante los recursos y servicios necesarios para contribuir a su "\
            "desarrollo físico, social, emocional, cultural, educativo y ocupacional-profesional, "\
            "como complemento a su formación intelectual, académica y ética."
        services_provided = "\u2022 Acomodo Razonable\n"\
